...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function draw() {
      ...
      this.ctx.fillRect((this.player1.pos[1] - 1) * 10, (this.player1.pos[0] - 1) * 10, 10, 10);
    }
  }, {
    key: 'checkCollision',
    ...
    value: function checkWallCollision() {
      if (this.player1.pos[1] < -1 || this.player1.pos[1] > 70 || this.player1.pos[0] < 1 || this.player1.pos[0] > 50) {
        alert('hit a wall');
        return true;
      }
    }
